...
//     version 1.14.0
//     from Assets/Scripts/UITrigger.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/UITrigger.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @UITrigger: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""UIGame"",
            ""id"": ""c8d4195e-bcc2-423b-bbdd-ab37db58024c"",
            ""actions"": [
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""621e41ce-b4ec-4561-a298-c3b46cb69a61"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""85d151d4-0607-499e-94dc-bbedae494dae"",
    ...
    ""controlSchemes"": []
        ...
        m_UIGame_Pause = m_UIGame.FindAction("Pause", throwIfNotFound: true);
    }

    ~@UITrigger()
    {
        UnityEngine.Debug.Assert(!m_UIGame.enabled, "This will cause a leak and performance issues, UITrigger.UIGame.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_UIGame_Pause;
    /// <summary>
    /// Provides access to input actions defined in input action map "UIGame".
    /// </summary>
    public struct UIGameActions
    {
        private @UITrigger m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIGameActions(@UITrigger wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "UIGame/Pause".
        /// </summary>
        public InputAction @Pause => m_Wrapper.m_UIGame_Pause;
        /// <summary>
